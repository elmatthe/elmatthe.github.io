Attribute VB_Name = "Print_from_excel_to_fit_page"
' ============================================================
'  Print_from_excel_to_fit_page.bas
...
Private Sub ExportSheetToPDF(sheetName As String, _
    ...
    ' Choose orientation that maximizes scaling while keeping content on one page.
    ...
    With ws.PageSetup
        ...
        ' Tidy margins (0.5 in = 36 pts; PageSetup uses points).
